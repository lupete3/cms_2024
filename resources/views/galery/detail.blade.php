      ...
      <div class="container py-5">
        ...
        <nav aria-label="breadcrumb animated slideInDown">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('products.all') }}">Produists</a></li>
            ...
            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
              ...
              <div class="row g-3">
                  ...
                  <div class="col-sm-7 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a class="btn btn-primary px-3 mb-2" href="mailto:lupeteplacide@gmail.com?subject=Bonjour cher assistant&body={{Request::getUri()}}"><i class="fas fa-envelope"></i> Contacter le fournisseur </a>
                        </div>
                        <div class="col-md-6">
                            <a class="btn btn-outline-primary px-2" href="https://wa.me/243978333654"><i class="fas fa-phone"></i> Contactez-nous</a>
                        </div>
                    </div>
                  </div>
